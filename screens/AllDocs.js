...
const UnlockListComp = ({ title, iconName, onPress }) => (
  <TouchableOpacity
    style={{
      backgroundColor: COLORS.grey,
      alignItems: "center",
...
export default function AllDocs({ navigation }) {
  return (
    <View style={styles.screenStyle}>
      <ScrollView>
        ...
        <View style={{ flexDirection: "row" }}>
          <UnlockListComp title="Inductions" />
          <ListComp title="Permits" />
        </View>
        <View style={{ flexDirection: "row" }}>
          <ListComp title="Programme" />
          <ListComp title="Drawings" />
        </View>
        <View style={{ flexDirection: "row" }}>
